 ...
 * @returns {string}
 */
export function extract_jwt(contents) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.extract_jwt(contents);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {boolean}
 */
export function validate_jwt(jwt) {
    const ptr0 = passStringToWasm0(jwt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_jwt(ptr0, len0);
    return ret !== 0;
}

const HostKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_hostkey_free(ptr >>> 0, 1));
...
export class HostKey {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        HostKeyFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_hostkey_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.hostkey_new();
        this.__wbg_ptr = ret >>> 0;
        HostKeyFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {string}
    ...
    get public_key() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.hostkey_public_key(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get seed() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.hostkey_seed(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasmcloud-browser-host_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
